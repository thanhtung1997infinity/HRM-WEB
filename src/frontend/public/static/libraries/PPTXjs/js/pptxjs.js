...
(function ($) {
  $.fn.pptxToHtml = function (options) {
    ...
    $("#" + divId).prepend(
      $("<span></span>")
        .attr({
          ...
          style:
            "display:block; color:blue; font-size:20px; width:50%; margin:0 auto;",
        })
        .html("Loading...")
    );
    ...
    function processSingleSlide(zip, sldFileName, index, slideSize) {
      ...
      var sldLayoutClrOvr =
        slideLayoutContent["p:sldLayout"]["p:clrMapOvr"][
    ...
    function processNodesInSlide(nodeKey, nodeValue, warpObj) {
      ...
      switch (nodeKey) {
        ...
        case "mc:AlternateContent": //Equations and formulas as Image
          var mcFallbackNode = getTextByPathList(nodeValue, [
            "mc:Fallback",
            "p:sp",
          ]);
    ...
    function genShape(
      ...
      if (shapType !== undefined && custShapType === undefined) {
        ...
        var startPoint = getTextByPathList(pathLstNode, [
          "a:path",
          "a:moveTo",
          "a:pt",
          "attrs",
    ...
    function genBuChar(
      ...
      if (buFontSize !== undefined) {
        ...
        if (buFontSize !== undefined) {
          ...
          //dfltBultSize = XXpt
          var dfltBultSizeNoPt = dfltBultSize.substr(
            0,
      ...
      if (buType == "TYPE_BULLET") {
        ...
        var marginLeft =
          ...
          914400;
        var marginRight =
          (parseInt(getTextByPathList(pPrNode, ["attrs", "marR"])) * 96) /
          914400;
        ...
        for (var i = 0; i < trNodes.length; i++) {
          ...
          if (tcNodes.constructor === Array) {
            for (var j = 0; j < tcNodes.length; j++) {
              ...
              var colSpan = getTextByPathList(tcNodes[j], [
                "attrs",
                "gridSpan",
              ]);
    ...
    function genDiagram(node, warpObj) {
      ...
      ///get drawing#.xml
      var dgmDrwFileName = "";
      var dataModelExt = getTextByPathList(dgmData, [
        "dgm:dataModel",
        "dgm:extLst",
        "a:ext",
        "dsp:dataModelExt",
      ...
      var dgmDrwSpArray = getTextByPathList(dgmDrwFile, [
        "dsp:drawing",
        "dsp:spTree",
        "dsp:sp",
      ]);
    ...
    function getFontColorPr(node, spNode, type, slideMasterTextStyles) {
      ...
      if (txtBrdrNode !== undefined) {
        ...
        var brdSize =
          parseInt(txBrdAry[0].substring(0, txBrdAry[0].indexOf("pt"))) *
            (4 / 3) +
          "px";
    ...
    function getTextDirection(node, type, slideMasterTextStyles) {
      ...
      var isDir = getTextByPathList(slideMasterTextStyles, [
        "p:bodyStyle",
        lvlNode,
        "attrs",
        "rtl",
    ...
    function getBorder(node, isSvgMode, bType) {
      ...
      // Border color
      var borderColor = getTextByPathList(lineNode, [
        "a:solidFill",
        "a:srgbClr",
        "attrs",
        "val",
      ...
      if (borderColor === undefined) {
        var schemeClrNode = getTextByPathList(lineNode, [
          "a:solidFill",
          "a:schemeClr",
        ]);
      ...
      if (borderColor === undefined) {
        var schemeClrNode = getTextByPathList(node, [
          "p:style",
          "a:lnRef",
          "a:schemeClr",
        ]);
        ...
        if (borderColor !== undefined) {
          var shade = getTextByPathList(schemeClrNode, [
            "a:shade",
            "attrs",
            "val",
          ]);
    ...
    function getSlideBackgroundFill(
      ...
      if (bgPr !== undefined) {
        ...
        if (bgRef["a:srgbClr"] !== undefined) {
          ...
          //a:schemeClr
          var schemeClr = getTextByPathList(bgRef, [
            "a:schemeClr",
            "attrs",
            "val",
          ]);
      ...
      if (bgPr !== undefined) {
        ...
        for (var i = 0; i < gsLst.length; i++) {
          ...
          if (gsLst[i]["a:srgbClr"] !== undefined) {
            if (phClr === undefined) {
              lo_color = getTextByPathList(gsLst[i], [
                "a:srgbClr",
                "attrs",
                "val",
              ]); //#...
            }
            lo_tint = getTextByPathList(gsLst[i], [
              "a:srgbClr",
              "a:tint",
              "attrs",
              "val",
            ...
            //a:schemeClr
            if (phClr === undefined) {
              var schemeClr = getTextByPathList(gsLst[i], [
                "a:schemeClr",
                "attrs",
                "val",
              ]);
              lo_color = getSchemeColorFromTheme(
                "a:" + schemeClr,
                slideMasterContent
              ); //#...
            }
        ...
        for (var i = 0; i < gsLst.length; i++) {
          if (i == gsLst.length - 1) {
            if (phClr === undefined) {
              ...
              bgcolor +=
                "rgba(" + hexToRgbNew(phClr) + "," + tint_ary[i] + ")" + ");";
            }
          } else {
            if (phClr === undefined) {
              bgcolor +=
    ...
    function getSolidFill(node) {
      ...
      if (node["a:srgbClr"] !== undefined) {
        ...
        //a:schemeClr
        var schemeClr = getTextByPathList(node, [
          "a:schemeClr",
          "attrs",
          "val",
        ]);
    ...
    function getColorOpacity(solidFill) {
      ...
      if (solidFill["a:srgbClr"] !== undefined) {
        var tint = getTextByPathList(solidFill, [
          "a:srgbClr",
          "a:tint",
          "attrs",
          "val",
